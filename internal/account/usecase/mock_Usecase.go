...
import (
	...
	model "github.com/quachhoang2002/Go/internal/model"
...
func (_m *MockUsecase) All(ctx context.Context) ([]domain.Account, error) {
	ret := _m.Called(ctx)
...
func (_c *MockUsecase_All_Call) Return(_a0 []model.Account, _a1 error) *MockUsecase_All_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUsecase_All_Call) RunAndReturn(run func(context.Context) ([]model.Account, error)) *MockUsecase_All_Call {
	_c.Call.Return(run)
	return _c
}
